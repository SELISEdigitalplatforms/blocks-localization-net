    ...
    <body>
      <trans-unit id=""1"">
        ...
        public async Task CreateKeyTimelineEntryAsync_SavesTimeline()
        {
            ...
            var task = method.Invoke(_service, new object?[] { previous, current, "Test" }) as Task;
            await task!;
        ...
        public async Task CreateKeyTimelineEntryAsync_ExceptionSwallowed()
        {
            ...
            var task = method.Invoke(_service, new object?[] { (BlocksLanguageKey?)null, current, "Test" }) as Task;
            // Should not throw
            await task!;
        }
